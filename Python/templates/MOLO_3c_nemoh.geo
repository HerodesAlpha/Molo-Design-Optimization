...
//+
Symmetry {1, 0, 0, -2.5*p05x} {
  Duplicata { Surface{85}; Surface{105}; Surface{80}; Surface{100}; Surface{75}; Surface{90}; Surface{95}; Surface{70}; Surface{60}; Surface{65}; }
}
//+
...
//+
Translate {0, 0, -vdist} {
  Duplicata { Point{1}; Point{8}; Point{274}; Point{310}; }
}
//+
Line(158) = {397, 399};
//+
...
Line(161) = {398, 397};
//+
Curve Loop(7) = {158, 159, 160, 161};
//+
Plane Surface(156) = {7};
//+
Transfinite Surface {156} = {399, 397, 398, 400};
//+
Transfinite Curve {160, 158} = nop_lower_long_edge Using Progression 1;
//+
Transfinite Curve {161, 159} = nop_lower_short_edge Using Progression 1;
//+
Recombine Surface {156};
//+
Symmetry {-Sqrt(3)/2, 1/2, 0, 0} {
  Duplicata { Surface{26}; Surface{22}; Surface{1}; Surface{3}; Surface{4}; Surface{2}; Surface{30}; Surface{5}; Surface{55}; Surface{34}; Surface{50}; Surface{6}; Surface{45}; Surface{40}; Surface{35}; Surface{85}; Surface{105}; Surface{80}; Surface{90}; Surface{100}; Surface{95}; Surface{75}; Surface{70}; Surface{60}; Surface{65}; Surface{150}; Surface{135}; Surface{155}; Surface{115}; Surface{140}; Surface{125}; Surface{110}; Surface{145}; Surface{130}; Surface{156}; Surface{120}; }
}
//+
Symmetry {-Sqrt(3)/2, -1/2, 0, 0} {
  Duplicata { Surface{167}; Surface{162}; Surface{182}; Surface{172}; Surface{197}; Surface{187}; Surface{192}; Surface{207}; Surface{217}; Surface{212}; Surface{222}; Surface{202}; Surface{232}; Surface{227}; Surface{247}; Surface{237}; Surface{242}; Surface{257}; Surface{267}; Surface{262}; Surface{272}; Surface{252}; Surface{282}; Surface{277}; Surface{297}; Surface{287}; Surface{292}; Surface{307}; Surface{322}; Surface{312}; Surface{327}; Surface{302}; Surface{337}; Surface{317}; Surface{332}; Surface{177}; }
}
