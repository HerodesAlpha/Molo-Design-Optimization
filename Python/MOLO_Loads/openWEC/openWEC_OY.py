...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.sketchShape.setPixmap(QtGui.QPixmap("src/oyster_shape.png"))
        ...
        self.lengthLabel = QtWidgets.QLabel(self.tabMesh)
        self.lengthLabel.setObjectName("lengthLabel")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.lengthLabel)
        self.lengthBox = QtWidgets.QLineEdit(self.tabMesh)
        self.lengthBox.setObjectName("lengthBox")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lengthBox)
        self.heightLabel = QtWidgets.QLabel(self.tabMesh)
        self.heightLabel.setObjectName("heightLabel")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.heightLabel)
        self.widthLabel = QtWidgets.QLabel(self.tabMesh)
        self.widthLabel.setObjectName("widthLabel")
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.widthLabel)
        self.heightBox = QtWidgets.QLineEdit(self.tabMesh)
        self.heightBox.setObjectName("heightBox")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.heightBox)
        self.widthBox = QtWidgets.QLineEdit(self.tabMesh)
        self.widthBox.setObjectName("widthBox")
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.widthBox)
        self.hoslLabel = QtWidgets.QLabel(self.tabMesh)
        self.hoslLabel.setObjectName("hoslLabel")
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.hoslLabel)
        self.hoslBox = QtWidgets.QLineEdit(self.tabMesh)
        self.hoslBox.setText("")
        self.hoslBox.setObjectName("hoslBox")
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.hoslBox)
        ...
        self.formLayout_3.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.rhoLabel)
        self.rhoBox = QtWidgets.QLineEdit(self.tabMesh)
        self.rhoBox.setObjectName("rhoBox")
        self.formLayout_3.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.rhoBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.hoslLabel.setText(_translate("openWEC", "Height Above Seabed", None))
        self.hoslBox.setPlaceholderText(_translate("openWEC", "in meter", None))
    ...
    def makeMesh(self, MainWindow):
        ...
        hosb = float(self.hoslBox.text())
        nPanels = int(self.nPanelBox.text())
        waterDepth = float(self.waterDepthBox.text())

        if (np.abs(height + hosb - waterDepth) > 0.01):
            print('Attention: your water depth is not equal to the sum of your oyster height and hinge height!')

        box = mt.box(width, length, 0.9 * height, [0.0, 0.0, -0.9 / 2.0 * height])
        wedge = mt.wedge(width, length, 0.1 * height, [0.0, 0.0, -0.9 * height])
        mesh = mt.Mesh()
        mesh.combineMesh(box, wedge)

        meshFile = os.path.join(self.wDir, 'Calculation', 'mesh', 'axisym')
        mt.writeMesh(mesh, meshFile)
        print("Meshing...")
    ...
    def runNemohCode(self):
        ...
        try:
            ...
            rhoW = 1025.0
        zG = -1.0 * float(self.heightBox.text())
    ...
    def runSimulation(self):
        ...
        sys.path.insert(0, './Run')
        import openWEC.makeWaveFex as wav

        import openWEC.processNemoh as pn

        import openWEC.wecSim as wc
    ...
    def openFile(self):
        ...
        self.hoslBox.setText(inData[4].split('\t')[0])
    ...
    def saveFile(self):
        fname = QtWidgets.QFileDialog.getSaveFileName(self, 'Save file',
                                                      os.path.join(self.wDir), '*.oy')[0]

        with open(fname, 'w') as f:
            # Write Mesh Tab properties
            f.write('Mesh Properties\n')
            f.write(self.lengthBox.text() + "\t Oyster Length\n")
            f.write(self.heightBox.text() + "\t Oyster Height\n")
            f.write(self.widthBox.text() + "\t Oyster Width\n")
            f.write(self.hoslBox.text() + "\t Oyster Height Above Sea Level\n")
