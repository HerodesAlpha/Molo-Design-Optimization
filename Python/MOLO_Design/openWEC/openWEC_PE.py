...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.sketchShape.setPixmap(QtGui.QPixmap("src/pelamis_shape.png"))
        ...
        self.spacingLabel = QtWidgets.QLabel(self.tabMesh)
        self.spacingLabel.setObjectName("spacingLabel")
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.spacingLabel)
        self.spacingBox = QtWidgets.QLineEdit(self.tabMesh)
        self.spacingBox.setObjectName("spacingBox")
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.spacingBox)
    ...
    def makeMesh(self, MainWindow):
        ...
        print("Meshing...")
        self.genericThread = GenericThread(ne.createMeshOpt, cG, nPanels / 2, int(0), rho=float(self.rhoBox.text()),
                                           nbody=2, xG=[-(length + spacing) / 2.0, (length + spacing) / 2.0])
