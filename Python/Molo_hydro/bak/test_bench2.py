...
if step1:
    ...
    hydro_mesh_symmetri, mesh_file = nemoh.mesh(fio.nemoh_dir, hs_floater, sym=1)
...
if step3:
    ...
    vertices, faces = nemoh.get_poten_pressure(fio.nemoh_results, 1)
    nemoh_mesh = Mesh(vertices[:, 0:3], faces)
    nemoh_mesh.show()
