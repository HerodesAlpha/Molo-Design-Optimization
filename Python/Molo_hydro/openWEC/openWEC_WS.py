...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.geoProp)
        ...
        self.sketchShape.setMaximumSize(QtCore.QSize(380, 287))
        self.sketchShape.setText("")
        self.sketchShape.setPixmap(QtGui.QPixmap("src/wavestar_shape.png"))
        self.sketchShape.setScaledContents(True)
        self.sketchShape.setAlignment(QtCore.Qt.AlignHCenter)
        ...
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.genProp)
        self.diameterLabel = QtWidgets.QLabel(self.tabMesh)
        self.diameterLabel.setObjectName("diameterLabel")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.diameterLabel)
        self.diameterBox = QtWidgets.QLineEdit(self.tabMesh)
        self.diameterBox.setObjectName("diameterBox")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.diameterBox)
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.waterDepthLabel)
        self.waterDepthBox = QtWidgets.QLineEdit(self.tabMesh)
        self.waterDepthBox.setObjectName("waterDepthBox")
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.waterDepthBox)
        self.rhoLabel = QtWidgets.QLabel(self.tabMesh)
        font = QtGui.QFont()
        font.setFamily("Raleway")
        self.rhoLabel.setFont(font)
        self.rhoLabel.setObjectName("rhoLabel")
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.rhoLabel)
        self.rhoBox = QtWidgets.QLineEdit(self.tabMesh)
        self.rhoBox.setObjectName("rhoBox")
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.rhoBox)
        ...
        self.wavType.addItem("")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.wavType)
        ...
        self.formLayout_5.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.makePlot1)
        ...
        self.formLayout_5.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.lowPlotTitle)
        ...
        self.formLayout_5.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.plotX2)
        ...
        self.formLayout_5.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.plotY2)
        ...
        self.chooseY2.addItem("")
        self.chooseY2.addItem("")
        self.formLayout_5.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.chooseY2)
        ...
        self.chooseX2.addItem("")
        self.chooseX2.addItem("")
        self.formLayout_5.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.chooseX2)
        ...
        self.formLayout_5.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.makePlot2)
        spacerItem3 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.formLayout_5.setItem(7, QtWidgets.QFormLayout.LabelRole, spacerItem3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.diameterLabel.setText(_translate("openWEC", "Diameter", None))
        self.diameterBox.setPlaceholderText(_translate("openWEC", "in meter", None))
    ...
    def runSimulation(self):
        ...
        if (wavType == 0):
            ...
            self.time, self.posZ, self.velZ, self.Fpto = wc.simBody1DOF(time, Fex, Fdamp, dampType, M, Mainf, c, alpha,
                                                                        beta)
    ...
    def openFile(self):
        ...
        self.diameterBox.setText(inData[1].split('\t')[0])
        self.waterDepthBox.setText(inData[2].split('\t')[0])
        self.rhoBox.setText(inData[3].split('\t')[0])
        self.nPanelBox.setText(inData[4].split('\t')[0])

        self.omegaStart.setText(inData[6].split('\t')[0])
        self.omegaStop.setText(inData[7].split('\t')[0])
        self.omegaStep.setText(inData[8].split('\t')[0])
        self.wavDirCheck.setChecked(inData[9].split('\t')[0] == 'True')
        self.wavDirStart.setText(inData[10].split('\t')[0])
        self.wavDirStop.setText(inData[11].split('\t')[0])
        self.wavDirStep.setText(inData[12].split('\t')[0])
        self.irfCheck.setChecked(inData[13].split('\t')[0] == 'True')
        self.irfDur.setText(inData[14].split('\t')[0])
        self.irfStep.setText(inData[15].split('\t')[0])
        self.kochinCheck.setChecked(inData[16].split('\t')[0] == 'True')
        self.kochinStart.setText(inData[17].split('\t')[0])
        self.kochinStop.setText(inData[18].split('\t')[0])
        self.kochinStep.setText(inData[19].split('\t')[0])
        self.fsCheck.setChecked(inData[20].split('\t')[0] == 'True')
        self.fsDeltaX.setText(inData[21].split('\t')[0])
        self.fsDeltaY.setText(inData[22].split('\t')[0])
        self.fsLengthX.setText(inData[23].split('\t')[0])
        self.fsLengthY.setText(inData[24].split('\t')[0])

        self.wavType.setCurrentIndex(int(inData[26].split('\t')[0]))
        self.wavHBox.setText(inData[27].split('\t')[0])
        self.wavTBox.setText(inData[28].split('\t')[0])
        self.dampSelect.setCurrentIndex(int(inData[29].split('\t')[0]))
        if int(inData[29].split('\t')[0]) == 0:
            self.msupEdit.setText(inData[30].split('\t')[0].split(';')[0])
            self.bsupEdit.setText(inData[30].split('\t')[0].split(';')[1])
            self.csupEdit.setText(inData[30].split('\t')[0].split(';')[2])
        else:
            self.fdampEdit.setText(inData[30].split('\t')[0])
        self.simTimeBox.setText(inData[31].split('\t')[0])
        self.dtBox.setText(inData[32].split('\t')[0])
    ...
    def saveFile(self):
        ...
        with open(fname, 'w') as f:
            ...
            f.write(self.diameterBox.text() + "\t Float Diameter\n")
