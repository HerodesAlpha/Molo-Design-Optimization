"""
Calculate forces script for computing section forces from environmental conditions.

This script loads a design candidate, sets up environmental contour lines,
and calculates expected largest maximum forces for different wave conditions.
"""
...
if __name__ == '__main__':
    ...
    for stwc in this_candidate.contourline:
        ...
        print(f' {stwc.hs:6.1f} {stwc.tp:6.1f} {stwc.gamma:6.1f}  {fz_elm:6.2f}  {my_elm:6.1f} ')
