# 1 "D:/dev/MOLO_Design_Optimization/Fortran/Source/fNemoh/Solver/Core/PREPARE_MESH.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
!   This module sets variables related to the Mesh and common for all Body conditions or problems
!
!   Changes in version 1.2 (Code Acceleration of the Calculation of Influence Coefficients of Nemoh)
!       Change normal vector pointing to x direction to a warning
!
!   @author yedtoss
!   @version 1.2
MODULE PREPARE_MESH
...
CONTAINS
    ...
    SUBROUTINE GOMG
        ...
        REAL:: DPOINT,T2,TI1,TT1,TT2,TT3,TT4
        INTEGER :: NSYM
