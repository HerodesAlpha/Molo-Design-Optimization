# 1 "D:/dev/MOLO_Design_Optimization/Fortran/Source/fNemoh/Solver/NEMOH.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "D:/dev/MOLO_Design_Optimization/Fortran/Source/fNemoh/Solver/logging/logging.h" 1


# 79 "D:/dev/MOLO_Design_Optimization/Fortran/Source/fNemoh/Solver/NEMOH.f90" 2
MODULE NEMOH
    ...
    !if(logp(info))write(logu,*)trim(logl(info,"D:/dev/MOLO_Design_Optimization/Fortran/Source/fNemoh/Solver/NEMOH.f90",222))," ", "here, have some info"
