# 1 "D:/dev/MOLO_Design_Optimization/Fortran/Source/fNemoh/Solver/logging/flogging.F90"
# 1 "<built-in>"
# 1 "<command-line>"
...
contains
  ...
  function logl(level, filename, linenum)
    ...
    !else
    !  show_colors = isatty(6) .and. .not. disable_colors
    !endif
    ! This works in ifort and gfortran (log_unit is 6 here because log_lead is an internal string)
...
# 303 "D:/dev/MOLO_Design_Optimization/Fortran/Source/fNemoh/Solver/logging/flogging.F90"
